 ...
 *                              int maxMap):
 */
  __pyx_tuple__20 = PyTuple_Pack(26, __pyx_n_s_xrobot, __pyx_n_s_yrobot, __pyx_n_s_xends, __pyx_n_s_yends, __pyx_n_s_maxMap, __pyx_n_s_nPoints, __pyx_n_s_index, __pyx_n_s_x, __pyx_n_s_y, __pyx_n_s_x_iterator, __pyx_n_s_x1, __pyx_n_s_y1, __pyx_n_s_temp, __pyx_n_s_x0, __pyx_n_s_y0, __pyx_n_s_error, __pyx_n_s_deltax, __pyx_n_s_deltay, __pyx_n_s_ystep, __pyx_n_s_steep, __pyx_n_s_lineMap, __pyx_n_s_lineMap_view, __pyx_n_s_xis_view, __pyx_n_s_yis_view, __pyx_n_s_idx, __pyx_n_s_xyio); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__20);
  __Pyx_GIVEREF(__pyx_tuple__20);
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(5, 0, 26, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_MapUtils_fclad_pyx, __pyx_n_s_getMapCellsFromRay_fclad, 8, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) __PYX_ERR(0, 8, __pyx_L1_error)
